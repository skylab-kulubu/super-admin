...
import { GecekoduStaff } from '@/types'; // Use GecekoduStaff type
import Button from '@/components/ui/Button';
import Image from 'next/image';
import { PencilSquareIcon, UserCircleIcon } from '@heroicons/react/24/outline';

interface GecekoduStaffTableProps {
  staffMembers: GecekoduStaff[];
  onEditStaff: (staff: GecekoduStaff) => void;
}

const GecekoduStaffTable: React.FC<GecekoduStaffTableProps> = ({ staffMembers, onEditStaff }) => {
  return (
...
export default GecekoduStaffTable;
