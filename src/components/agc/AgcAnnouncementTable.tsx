...
import { AgcAnnouncement } from '@/types'; // Use AgcAnnouncement type
import Button from '@/components/ui/Button';
import { PencilSquareIcon, CheckCircleIcon, XCircleIcon } from '@heroicons/react/24/outline';

interface AgcAnnouncementTableProps {
  announcements: AgcAnnouncement[];
  onEditAnnouncement: (announcement: AgcAnnouncement) => void;
}

const AgcAnnouncementTable: React.FC<AgcAnnouncementTableProps> = ({ announcements, onEditAnnouncement }) => {
  return (
...
export default AgcAnnouncementTable;
