...
import { AgcEvent } from '@/types'; // Use AgcEvent type
import Button from '@/components/ui/Button';
import { PencilSquareIcon, PhotoIcon, CheckCircleIcon, XCircleIcon } from '@heroicons/react/24/outline';

interface AgcEventTableProps {
  events: AgcEvent[];
  onEditEvent: (event: AgcEvent) => void;
  onManagePhotos: (event: AgcEvent) => void;
}

const AgcEventTable: React.FC<AgcEventTableProps> = ({ events, onEditEvent, onManagePhotos }) => {
  return (
