...
import { BizbizeAnnouncement } from '@/types';
import Button from '@/components/ui/Button';
import { PencilSquareIcon, CheckCircleIcon, XCircleIcon } from '@heroicons/react/24/outline';

interface BizbizeAnnouncementTableProps {
  announcements: BizbizeAnnouncement[];
  onEditAnnouncement: (announcement: BizbizeAnnouncement) => void;
}

const BizbizeAnnouncementTable: React.FC<BizbizeAnnouncementTableProps> = ({ announcements, onEditAnnouncement }) => {
  return (
...
export default BizbizeAnnouncementTable;
