...
import { BizbizeStaff } from '@/types';
import Button from '@/components/ui/Button';
import Image from 'next/image';
import { PencilSquareIcon, UserCircleIcon } from '@heroicons/react/24/outline';

interface BizbizeStaffTableProps {
  staffMembers: BizbizeStaff[];
  onEditStaff: (staff: BizbizeStaff) => void;
}

const BizbizeStaffTable: React.FC<BizbizeStaffTableProps> = ({ staffMembers, onEditStaff }) => {
  return (
...
export default BizbizeStaffTable;
